...
## Project Structure
    ...
    ├── sneh_figma_test_app_22681  # Django project configurations
...
1. Clone this repo and `cd sneh_figma_test_app_22681`
...
2. Clone this repo and `cd sneh_figma_test_app_22681`
